...
public class BffController {
    ...
    // Requiere que el JWT de Entra ID traiga el scope Pets.Access
    // (el frontend lo solicita explícitamente vía MSAL al hacer login).
    @PreAuthorize("hasAuthority('SCOPE_Pets.Access')")
